...
ai_course.className = "deep-learning-course";
ai_course.src = "../../photos/deep_learning.png";

const name_of_the_course = document.createElement("div");
name_of_the_course.textContent = "Introduction To Deep Learning";
...
let text_of_course_information = "This course dives into the cutting-edge field of deep learning, a subset of machine learning where \n" +
    "artificial neural networks, inspired by the human brain, learn from large amounts of data. This course \n" +
    "is designed to equip students with the foundational skills to build, train, and deploy deep learning \n" +
    "models for various applications such as image and speech recognition, natural language processing, \n" +
    "and more."
