...
ai_course.className = "probability-and-statistics-course";
ai_course.src = "../../photos/probability_and_statistics.png";

const name_of_the_course = document.createElement("div");
name_of_the_course.textContent = "Introduction To Probability & Statistics";
...
let text_of_course_information = "This course introduces the fundamental concepts of probability and statistics, which are crucial for\n" +
    "data analysis, scientific research, and decision-making in various fields such as business, engineering,\n" +
    "and the social sciences. Students will learn how to collect, analyze, interpret, and present data using \n" +
    "statistical techniques and probability theory."
