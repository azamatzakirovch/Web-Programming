...
ai_course.className = "Linear-algebra-course";
ai_course.src = "../../photos/linear_algebra.png";

const name_of_the_course = document.createElement("div");
name_of_the_course.textContent = "Introduction To Linear Algebra";
...
let text_of_course_information = "This course provides a thorough introduction to Linear Algebra, a fundamental branch of mathematics\n" +
    "essential for understanding and working with multidimensional data in various fields, including science, \n" +
    "engineering, computer science, and economics. The course covers key concepts, theories, and practical\n" +
