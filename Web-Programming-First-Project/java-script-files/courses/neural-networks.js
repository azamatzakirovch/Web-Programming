...
ai_course.className = "neural-networks-course";
ai_course.src = "../../photos/neural_networks.png";

const name_of_the_course = document.createElement("div");
name_of_the_course.textContent = "Introduction To Neural Networks";
...
let text_of_course_information = "This course explores the fascinating world of neural networks, a cornerstone of artificial intelligence that \n" +
    "models human brain functions to solve complex problems in various domains, including vision, speech,\n" +
    "and text processing. It provides a deep dive into the architectures, learning algorithms, and practical \n" +
