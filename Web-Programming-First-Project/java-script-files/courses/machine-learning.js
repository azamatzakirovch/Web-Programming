...
ai_course.className = "machine-learning-course";
ai_course.src = "../../photos/machine_learning.png";

const name_of_the_course = document.createElement("div");
name_of_the_course.textContent = "Introduction To Machine Learning";
...
let text_of_course_information = "This course offers a comprehensive introduction to machine learning (ML), an essential branch of\n" +
    "artificial intelligence that focuses on building systems that learn from and make decisions based \n" +
    "on data. The course covers a range of machine learning techniques from basic to advanced,\n" +
    "providing students with the tools needed to implement ML algorithms in practice."
